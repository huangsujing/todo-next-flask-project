...
```
## 实训配套交付材料
项目额外配套实训佐证材料，统一存放在项目根目录的 `docs/` 文件夹下：
├── docs/                   
│   ├──screenshots  #项目多个时间提交所以以下对话截屏按数字命名
│      └── 1.docx
│      └── 2.docx  #该文件里有浏览器接口测试截图、 curl 接口测试截图、数据库截图
│      └── 3.docx
│      └── 4.docx
│      └── 5.docx
│      └── 6.docx
│      └── AI Code Review.docx      #代码审查对话截屏      
│   ├── video       # 项目演示录屏
│   ├── 个人实训报告总结.docx              # 个人实训报告
